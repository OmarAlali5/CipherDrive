...
export const Hero = () => {
  ...
  // Reduced-motion visitors get the finished layout immediately — no
  // entrance to opt out of, not just a faster one.
    ...
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-4 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        >
          <motion.span
            variants={fadeInUp}
            className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1 font-mono text-[11px] font-medium uppercase tracking-[0.12em] text-muted-foreground"
          >
          ...
          <motion.h1
            variants={fadeInUp}
            className="mt-6 text-4xl font-semibold leading-[1.1] tracking-tight text-foreground sm:text-5xl lg:text-[3.25rem]"
          >
          ...
          <motion.p
            variants={fadeInUp}
            className="mx-auto mt-5 max-w-md text-balance text-base leading-relaxed text-muted-foreground lg:mx-0"
          >
            <CipherRevealText
