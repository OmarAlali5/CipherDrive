      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <h1 className="anim-fade-up anim-delay-1 mt-8 text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-['Chakra_Petch'] font-semibold tracking-tight leading-[1.08] text-white">
              Absolute Privacy,{' '}
